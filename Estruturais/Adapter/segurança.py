...
class tradutor_adapter:
    def request(self) -> str:
        return f"Tradutor(Adapter): (Traduzido) {self.specific_request()[::-1]}"
...
if __name__ == "__main__":
    ...
    print(f"Adaptee : {voce_adaptee.specific_request()}", end ="  ")
    print("Adaptee: mas eu consigo se alguem ler pra mim")
    adapter = tradutor_adapter()
    adapter.request()
