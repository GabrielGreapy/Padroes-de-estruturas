...
Quando em um projeto há muitos objetos identicos (Exemplo: um jogo com folhas flutuando ao vento) , O jogo ocuparia muito 
...
Com dezenas de folhas ao vento voando o computador começaria a ficar cheio demais.
...
uma função chamada folhaAoVento.
